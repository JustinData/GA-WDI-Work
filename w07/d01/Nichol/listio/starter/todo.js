...
window.onload = function() {
  ...
  //     //create new item, put it in the list
  //     var text = document.getElementById("new-task-field").value;
  //     var item = new Item(text); 
  //     myTodoList.push(item);
...
//
//methods
//create new item ----  myItem = new Item("buy milk");
//delete item (remove it from the todolist) 
//mark item as completed ---- myItem.complete();
//delete from completed (remove it from the todolist)

//for display - grab this and append child

// <ol id="todo-items"></ol>

// <div class="actions">
// <span class="meta-data">Created on: 11/4/2013 </span>
