...
happy_tails.animals.push(fido)

twitty = Animal.new(twitty , bird)
happy_tails.animals.push(twitty)


monkey = Animal.new(george, monkey)
happy_tails.animals.push(george)
